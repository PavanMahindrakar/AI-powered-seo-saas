...
![BrightData](https://img.shields.io/badge/Bright%20Data-Web%20Intelligence-blue)
![License](https://img.shields.io/badge/License-MIT-green)

---
# 🎥 Product Demo

[![BrightSEO AI Banner](public/thumbnail.jpeg)](https://youtu.be/biXzyPQRDWY)
...
```mermaid
graph TD
    A[User Query] --> B[Bright Data Perplexity Search]
    B --> C[Web Intelligence Retrieval]
    C --> D[OpenAI GPT-4o-mini]
    D --> E[SEO Intelligence Analysis]
    E --> F[AI Report Generation]
    F --> G[Interactive Dashboard]
    G --> H[AI SEO Assistant]
```
